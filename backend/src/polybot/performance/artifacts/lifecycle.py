...
from .orders import PerformanceOrderRecorder
...
class PerformanceArtifacts:
    ...
    def __init__(
        ...
        *,
        ...
        self._orders = PerformanceOrderRecorder(self._output)
    ...
    def record_order_result(
        ...
        *,
        ...
        return self._orders.record(
            submitted_at_ms=submitted_at_ms, order=order, fill=fill
        )
    ...
    def _summary(
        ...
        *,
        ...
        return PerformanceSummaryInput(
            ...
            order_count=self._orders.order_count,
            fill_count=self._orders.fill_count,
            rejected_count=self._orders.rejected_count,
            coverage_gap_rejected_order_count=(
                self._orders.coverage_gap_rejected_order_count
            ),
            filled_notional_usdc=self._orders.filled_notional_usdc,
    ...
    def _validate_timestamp(self, timestamp_ms: int) -> None:
        require_nonnegative_timestamp_ms(timestamp_ms, "performance timestamp")
