export const PUBLIC_INFORMATION_PATH = {
  WELCOME: '/welcome', HELP: '/help', PRIVACY: '/privacy', TERMS: '/terms', SUPPORT: '/support',
} as const;
export const PUBLIC_INFORMATION_LABEL = {
  [PUBLIC_INFORMATION_PATH.WELCOME]: 'Overview', [PUBLIC_INFORMATION_PATH.HELP]: 'Help',
  [PUBLIC_INFORMATION_PATH.PRIVACY]: 'Privacy', [PUBLIC_INFORMATION_PATH.TERMS]: 'Terms', [PUBLIC_INFORMATION_PATH.SUPPORT]: 'Support',
} as const;
...
export function isPublicInformationPath(path: string): boolean {
  ...
  try { decodedPath = decodeURI(path); }
  catch { return false; }
