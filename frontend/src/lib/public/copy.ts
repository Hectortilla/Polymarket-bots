...
export const PUBLIC_COPY = {
  ...
  SIMULATION: "Paper orders do not place real orders or move funds. Simulated fills, fees, latency and balances do not establish real liquidity, queue priority, execution quality or future performance. This beta offers neither live execution nor a strategy marketplace.",
  SAVE_BEFORE_RUN: "Review the settings and save your private bot. Saving does not start execution. Press Run on the saved bot page.",
  ...
  RESTORE_QUARANTINE: "A restored backup stays quarantined: old sessions are revoked, execution is paused and deletion requests must be reconciled before access can reopen. Operators retain a minimal deletion receipt for that reconciliation during the audit period.",
  TERMS_SCOPE: "The service builds and runs private strategies with simulated execution. It does not place real trades, hold trading funds or guarantee profits, real-world fills or future performance. You choose your strategy and settings; examples explain functionality and are not promises of returns.",
  SUPPORT_PLACEHOLDER: "The public support mailbox is a placeholder for now. The operator must publish a monitored address and test delivery before inviting public accounts. No message form submits feedback in this preview.",
  ...
  HISTORY_RETENTION: `Terminal run history is limited to ${contract.resourcePolicy.retained_runs} runs per account for at most ${contract.resourcePolicy.history_retention_days} days. Saved bots and graphs remain until the account is deleted.`,
