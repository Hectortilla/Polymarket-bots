...
export const LIFECYCLE_COPY = {
  AMBIGUOUS_RESPONSE: 'The deletion response was not received. Your request may have completed. Try signing in again before retrying; revoked access may mean deletion was accepted.',
