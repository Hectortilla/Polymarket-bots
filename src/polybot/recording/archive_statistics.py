...
from .archive_errors import ArchiveFormatError
...
from .serialization import PayloadKind


_COUNT_FIELD_BY_KIND = {
    PayloadKind.MARKET_METADATA: "market_metadata",
    PayloadKind.BOOK_BASELINE: "book_baseline",
    PayloadKind.BOOK_DELTA: "book_delta",
    PayloadKind.PUBLIC_TRADE: "public_trade",
    PayloadKind.TICK_SIZE_CHANGE: "tick_size_change",
    PayloadKind.RESOLUTION: "resolution",
    PayloadKind.COVERAGE_GAP: "coverage_gap",
}
...
def _statistics_from_rows(
    *,
    ...
    counts_by_session = {
        session_id: {field: 0 for field in _COUNT_FIELD_BY_KIND.values()}
    ...
    try:
        for row in grouped_rows:
            ...
            counts_by_session[session_id][_COUNT_FIELD_BY_KIND[kind]] += event_count
